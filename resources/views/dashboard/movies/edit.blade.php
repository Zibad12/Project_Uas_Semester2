        ...
        <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                    <h3>Add movie</h3><br />
                    <!-- form validasi -->
                    <form class="forms-sample" action="{{ url('/dashboard/movies', $movie->id) }}" method="POST">
                        @csrf
                        @method('put')
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="title" name="title"
                                    placeholder="Title Movies" value="{{ $movie->title }}">
                                @if (count($errors) > 0)
                                ...
                                <select class="form-control" id="country_id" name="country_id">
                                    ...
                                    @foreach ($countries as $item)
                                        <option value="{{ $item->id }}"
                                            {{ $movie->country_id == $item->id ? 'selected' : '' }}>{{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
                                @if (count($errors) > 0)
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" id="genre_id" name="genre_id">
                                    ...
                                    @foreach ($genres as $item)
                                        <option value="{{ $item->id }}"
                                            {{ $movie->genre_id == $item->id ? 'selected' : '' }}>{{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
                                @if (count($errors) > 0)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control" id="release_date" name="release_date"
                                    placeholder="Release_date Movies" value="{{ $movie->release_date }}">
                                @if (count($errors) > 0)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" min="1" max="10" class="form-control" id="rating"
                                    name="rating" placeholder="Rating Movies" value="{{ $movie->rating }}">
                                @if (count($errors) > 0)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="url" class="form-control" id="poster_url" name="poster_url"
                                    placeholder="https://" value="{{ $movie->poster_url }}">
                                @if (count($errors) > 0)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="url" class="form-control" id="video_url" name="video_url"
                                    placeholder="https://" value="{{ $movie->video_url }}">
                                @if (count($errors) > 0)
