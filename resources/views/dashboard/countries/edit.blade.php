        ...
        <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- form validasi -->
                    <form class="forms-sample" action="{{ url('/dashboard/countries', $country->id) }}" method="POST">
                        @csrf
                        @method('put')
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="name" name="name"
                                    placeholder="Name Countries" value="{{ $country->name }}">
                                @if (count($errors) > 0)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="flag_url" name="flag_url"
                                    placeholder="https://" value="{{ $country->flag_url }}">
                                @if (count($errors) > 0)
